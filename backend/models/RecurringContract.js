...
const recurringContractSchema = new mongoose.Schema({
  ...
  agreementSnapshot: { type: String, default: "" },
  agreementHash: { type: String, default: "" },
  agreementAccepted: { type: Boolean, default: false },
  agreementAcceptedName: { type: String, trim: true, default: "", maxlength: 120 },
  agreementAcceptedAt: { type: Date, default: null },
  agreementAcceptedIp: { type: String, default: "" },
  agreementAcceptedUserAgent: { type: String, default: "", maxlength: 500 },
